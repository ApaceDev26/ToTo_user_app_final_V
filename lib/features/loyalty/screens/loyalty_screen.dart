...
import 'package:toto_user/features/loyalty/widgets/loyalty_bottom_sheet_widget.dart';
import 'package:toto_user/features/loyalty/widgets/loyalty_card_widget.dart';
import 'package:toto_user/features/loyalty/widgets/loyalty_history_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: isLoggedIn && !ResponsiveHelper.isDesktop(context) ? FloatingActionButton.extended(
        extendedPadding: const EdgeInsets.symmetric(horizontal: AppSpacing.x5l),
        backgroundColor: colors.accent,
        label: Text('convert_to_wallet_money'.tr, style: AppTypography.labelLg(colors.onAccent)),
        onPressed: (){
          Get.dialog(
