...
import 'package:toto_user/features/auth/widgets/sign_in/manual_login_widget.dart';
import 'package:toto_user/features/auth/widgets/sign_in/otp_login_widget.dart';
...
import 'package:toto_user/helper/centralize_login_helper.dart';
...
class _SignInViewState extends State<SignInView> {
    ...
    switch (centralizeLogin) {
      case CentralizeLoginType.otp:
        return OtpLoginWidget(
          ...
          onEmailViewClick: () {
            widget.isOtpViewEnable!(false);
            setState(() {
              authController.disableOtpView();
            });
          },
        );
  ...
  void _login(
    ...
    // Remove leading 0 for Bangladesh (+880) country code
    if (authController.countryDialCode == "+880" &&
        phone.isNotEmpty &&
        phone.startsWith("0")) {
      phone = phone.substring(1);
    }
