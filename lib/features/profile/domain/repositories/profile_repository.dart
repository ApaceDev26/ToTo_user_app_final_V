...
import 'package:toto_user/features/profile/domain/models/update_profile_response_model.dart';
...
class ProfileRepository implements ProfileRepositoryInterface {
  ...
  Future<Response> deleteUserWithOtp(String? otp) async {
    Map<String, dynamic> data = {"_method": "delete"};
    if (otp != null && otp.isNotEmpty) {
      data['otp'] = otp;
    }
    return await apiClient.postData(AppConstants.customerRemoveUri, data);
  }
