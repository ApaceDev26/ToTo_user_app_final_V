...
import 'package:toto_user/features/auth/widgets/sign_in/existing_user_bottom_sheet.dart';
...
import 'package:toto_user/features/verification/domein/model/verification_data_model.dart';
...
class VerificationScreenState extends State<VerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: isDesktop ? Colors.transparent : colors.canvas,
      body: SafeArea(
          child: Center(
            ...
            return Column(children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: context.width > 850 ? 50 : AppSpacing.lg,
                    vertical: AppSpacing.x3l),
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    const length = 6;
                    const gap = AppSpacing.xs; // 4px between boxes
                    final fieldWidth =
              ...
              GetBuilder<ProfileController>(builder: (profileController) {
                return Padding(
                  padding: EdgeInsets.symmetric(
                      horizontal: isDesktop ? AppSpacing.x3l : AppSpacing.sm),
                  child: AppButton(
                    label: 'verify'.tr,
                        ...
                        : () {
                            if (widget.firebaseSession != null &&
                              ...
                              Get.find<ProfileController>()
                                  .updateUserInfo(widget.userModel!,
                                ...
                                if (response.isSuccess) {
                                  ...
                                  showCustomSnackBar(response
                                      .updateProfileResponseModel!.message);
                                } else {
                                  showCustomSnackBar(response.message);
                                }
                              });
              ...
              Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: isDesktop ? 29 : AppSpacing.lg),
                child: Row(
                      ...
                      TextButton(
                        ...
                        child: Text(
                          ...
                          style: AppTypography.labelMd(
                              _seconds < 1 ? colors.accent : colors.inkFaint),
                        ),
                      ),
                    ]),
              ),
  ...
  void _handleVerifyResponse(
    ...
    if (response.authResponseModel != null &&
      ...
      if (widget.fromForgetPassword) {
        ...
        // Saved addresses → pickup screen; none → add address
