...
import 'package:toto_user/features/dashboard/domain/repositories/dashboard_repo.dart';
import 'package:toto_user/features/dashboard/domain/repositories/dashboard_repo_interface.dart';
import 'package:toto_user/features/dine_in/controllers/dine_in_controller.dart';
import 'package:toto_user/features/dine_in/domain/repositories/dine_in_repository.dart';
import 'package:toto_user/features/dine_in/domain/repositories/dine_in_repository_interface.dart';
import 'package:toto_user/features/dine_in/domain/services/dine_in_service.dart';
import 'package:toto_user/features/dine_in/domain/services/dine_in_service_interface.dart';
import 'package:toto_user/features/home/controllers/advertisement_controller.dart';
import 'package:toto_user/features/home/domain/repositories/advertisement_repository.dart';
import 'package:toto_user/features/home/domain/repositories/advertisement_repository_interface.dart';
import 'package:toto_user/features/home/domain/services/advertisement_service.dart';
import 'package:toto_user/features/home/domain/services/advertisement_service_interface.dart';
...
import 'package:toto_user/features/cart/domain/repositories/cart_repository.dart';
import 'package:toto_user/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:toto_user/features/cart/domain/services/cart_service.dart';
import 'package:toto_user/features/cart/domain/services/cart_service_interface.dart';
import 'package:toto_user/features/chat/controllers/chat_controller.dart';
import 'package:toto_user/features/chat/domain/repositories/chat_repository.dart';
import 'package:toto_user/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:toto_user/features/chat/domain/services/chat_service.dart';
import 'package:toto_user/features/chat/domain/services/chat_service_interface.dart';
import 'package:toto_user/features/checkout/controllers/checkout_controller.dart';
import 'package:toto_user/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:toto_user/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:toto_user/features/checkout/domain/services/checkout_service.dart';
import 'package:toto_user/features/checkout/domain/services/checkout_service_interface.dart';
...
import 'package:toto_user/features/home/domain/repositories/home_repository.dart';
import 'package:toto_user/features/home/domain/repositories/home_repository_interface.dart';
import 'package:toto_user/features/home/domain/services/home_service.dart';
import 'package:toto_user/features/home/domain/services/home_service_interface.dart';
...
import 'package:toto_user/features/order/domain/repositories/order_repository.dart';
import 'package:toto_user/features/order/domain/repositories/order_repository_interface.dart';
import 'package:toto_user/features/order/domain/services/order_service.dart';
import 'package:toto_user/features/order/domain/services/order_service_interface.dart';
import 'package:toto_user/features/product/domain/repositories/campaign_repository.dart';
import 'package:toto_user/features/product/domain/repositories/campaign_repository_interface.dart';
import 'package:toto_user/features/product/domain/services/campaign_service.dart';
import 'package:toto_user/features/product/domain/services/campaign_service_interface.dart';
import 'package:toto_user/features/restaurant/controllers/restaurant_controller.dart';
import 'package:toto_user/features/html/controllers/html_controller.dart';
import 'package:toto_user/features/html/domain/repositories/html_repository.dart';
import 'package:toto_user/features/html/domain/repositories/html_repository_interface.dart';
import 'package:toto_user/features/html/domain/services/html_service.dart';
import 'package:toto_user/features/html/domain/services/html_service_interface.dart';
import 'package:toto_user/features/language/domain/models/language_model.dart';
import 'package:toto_user/features/language/domain/repository/language_repository.dart';
import 'package:toto_user/features/language/domain/repository/language_repository_interface.dart';
import 'package:toto_user/features/language/domain/service/language_service.dart';
import 'package:toto_user/features/language/domain/service/language_service_interface.dart';
import 'package:toto_user/features/notification/controllers/notification_controller.dart';
import 'package:toto_user/features/notification/domain/repository/notification_repository.dart';
import 'package:toto_user/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:toto_user/features/notification/domain/service/notification_service.dart';
...
import 'package:toto_user/features/onboard/domain/repository/onboard_repository.dart';
import 'package:toto_user/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:toto_user/features/onboard/domain/service/notification_service.dart';
import 'package:toto_user/features/onboard/domain/service/onboard_service_interface.dart';
import 'package:toto_user/features/profile/controllers/profile_controller.dart';
import 'package:toto_user/features/profile/domain/repositories/profile_repository.dart';
import 'package:toto_user/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:toto_user/features/profile/domain/services/profile_service.dart';
...
import 'package:toto_user/features/restaurant/domain/repositories/restaurant_repository.dart';
import 'package:toto_user/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
import 'package:toto_user/features/restaurant/domain/services/restaurant_service.dart';
...
import 'package:toto_user/features/search/domain/repositories/search_repository.dart';
import 'package:toto_user/features/search/domain/repositories/search_repository_interface.dart';
import 'package:toto_user/features/search/domain/services/search_service.dart';
import 'package:toto_user/features/search/domain/services/search_service_interface.dart';
...
import 'package:toto_user/features/address/domain/reposotories/address_repo.dart';
import 'package:toto_user/features/address/domain/reposotories/address_repo_interface.dart';
import 'package:toto_user/features/address/domain/services/address_service.dart';
import 'package:toto_user/features/address/domain/services/address_service_interface.dart';
import 'package:toto_user/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:toto_user/features/auth/controllers/restaurant_registration_controller.dart';
import 'package:toto_user/features/auth/domain/reposotories/auth_repo.dart';
import 'package:toto_user/features/auth/domain/reposotories/auth_repo_interface.dart';
import 'package:toto_user/features/auth/domain/reposotories/deliveryman_registration_repo.dart';
import 'package:toto_user/features/auth/domain/reposotories/deliveryman_registration_repo_interface.dart';
import 'package:toto_user/features/auth/domain/reposotories/restaurant_registration_repo.dart';
import 'package:toto_user/features/auth/domain/reposotories/restaurant_registration_repo_interface.dart';
import 'package:toto_user/features/auth/domain/services/auth_service.dart';
import 'package:toto_user/features/auth/domain/services/auth_service_interface.dart';
import 'package:toto_user/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:toto_user/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:toto_user/features/auth/domain/services/restaurant_registration_service.dart';
import 'package:toto_user/features/auth/domain/services/restaurant_registration_service_interface.dart';
import 'package:toto_user/features/business/controllers/business_controller.dart';
import 'package:toto_user/features/business/domain/reposotories/business_repo.dart';
import 'package:toto_user/features/business/domain/reposotories/business_repo_interface.dart';
import 'package:toto_user/features/business/domain/services/business_service.dart';
import 'package:toto_user/features/business/domain/services/business_service_interface.dart';
import 'package:toto_user/features/category/controllers/category_controller.dart';
import 'package:toto_user/features/category/domain/reposotories/category_repository.dart';
import 'package:toto_user/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:toto_user/features/category/domain/services/category_service.dart';
import 'package:toto_user/features/category/domain/services/category_service_interface.dart';
import 'package:toto_user/features/coupon/domain/reposotories/coupon_repository.dart';
import 'package:toto_user/features/coupon/domain/reposotories/coupon_repository_interface.dart';
import 'package:toto_user/features/coupon/domain/services/coupon_service.dart';
import 'package:toto_user/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:toto_user/features/cuisine/controllers/cuisine_controller.dart';
import 'package:toto_user/features/cuisine/domain/repositories/cuisine_repository.dart';
import 'package:toto_user/features/cuisine/domain/repositories/cuisine_repository_interface.dart';
import 'package:toto_user/features/cuisine/domain/services/cuisine_service.dart';
import 'package:toto_user/features/cuisine/domain/services/cuisine_service_interface.dart';
import 'package:toto_user/features/dashboard/controllers/dashboard_controller.dart';
import 'package:toto_user/features/dashboard/domain/services/dashboard_service.dart';
...
import 'package:toto_user/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:toto_user/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:toto_user/features/favourite/domain/services/favourite_service.dart';
import 'package:toto_user/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:toto_user/features/interest/controllers/interest_controller.dart';
import 'package:toto_user/features/interest/domain/repositories/interest_repository.dart';
import 'package:toto_user/features/interest/domain/repositories/interest_repository_interface.dart';
import 'package:toto_user/features/interest/domain/services/interest_service.dart';
import 'package:toto_user/features/interest/domain/services/interest_service_interface.dart';
import 'package:toto_user/features/location/controllers/location_controller.dart';
import 'package:toto_user/features/location/domain/reposotories/location_repo.dart';
import 'package:toto_user/features/location/domain/reposotories/location_repo_interface.dart';
import 'package:toto_user/features/location/domain/services/location_service.dart';
...
import 'package:toto_user/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:toto_user/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:toto_user/features/loyalty/domain/services/loyalty_service.dart';
import 'package:toto_user/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:toto_user/features/product/controllers/product_controller.dart';
import 'package:toto_user/features/product/domain/repositories/product_repository.dart';
import 'package:toto_user/features/product/domain/repositories/product_repository_interface.dart';
import 'package:toto_user/features/product/domain/services/product_service.dart';
import 'package:toto_user/features/product/domain/services/product_service_interface.dart';
import 'package:toto_user/features/review/controllers/review_controller.dart';
import 'package:toto_user/features/review/domain/repositories/review_repository.dart';
import 'package:toto_user/features/review/domain/repositories/review_repository_interface.dart';
import 'package:toto_user/features/review/domain/services/review_service.dart';
import 'package:toto_user/features/review/domain/services/review_service_interface.dart';
import 'package:toto_user/features/splash/domain/repositories/splash_repository.dart';
import 'package:toto_user/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:toto_user/features/splash/domain/services/splash_service.dart';
import 'package:toto_user/features/splash/domain/services/splash_service_interface.dart';
import 'package:toto_user/features/verification/controllers/verification_controller.dart';
import 'package:toto_user/features/verification/domein/reposotories/verification_repo.dart';
import 'package:toto_user/features/verification/domein/reposotories/verification_repo_interface.dart';
import 'package:toto_user/features/verification/domein/services/verification_service.dart';
import 'package:toto_user/features/verification/domein/services/verification_service_interface.dart';
...
import 'package:toto_user/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:toto_user/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:toto_user/features/wallet/domain/repositories/withdraw_repository.dart';
import 'package:toto_user/features/wallet/domain/repositories/withdraw_repository_interface.dart';
import 'package:toto_user/features/wallet/domain/services/wallet_service.dart';
import 'package:toto_user/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:toto_user/features/wallet/domain/services/withdraw_service.dart';
...
/// Helper function to process language data in isolate
Map<String, String> _processLanguageData(Map<String, dynamic> rawData) {
...
/// Optimized language loading with concurrent processing
Future<Map<String, Map<String, String>>> _loadLanguagesAsync() async {
  Map<String, Map<String, String>> languages = {};

  // Load and process all language files concurrently
  List<Future<MapEntry<String, Map<String, String>>>> tasks = [];

  for (LanguageModel languageModel in AppConstants.languages) {
    tasks.add(_loadSingleLanguage(languageModel));
  }

  // Wait for all languages to be processed
  List<MapEntry<String, Map<String, String>>> results =
...
/// Load and process a single language file with error handling
Future<MapEntry<String, Map<String, String>>> _loadSingleLanguage(
    LanguageModel languageModel) async {
  try {
    final jsonString = await rootBundle
        .loadString('assets/language/${languageModel.languageCode}.json');
    final mappedJson = jsonDecode(jsonString) as Map<String, dynamic>;
    final processedData = _processLanguageData(mappedJson);
    ...
    print('Error loading language ${languageModel.languageCode}: $e');
    return MapEntry(
      '${languageModel.languageCode}_${languageModel.countryCode}',
      <String, String>{},
    );
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  WithdrawRepositoryInterface withdrawRepositoryInterface =
      WithdrawRepository(apiClient: Get.find());
  Get.lazyPut(() => withdrawRepositoryInterface);
  WithdrawServiceInterface withdrawServiceInterface =
      WithdrawService(withdrawRepositoryInterface: Get.find());
  ...
  Get.lazyPut(() => DashboardController(
      dashboardServiceInterface: Get.find(), sharedPreferences: Get.find()));
  ...
  /// Retrieving localized data (optimized)
  Map<String, Map<String, String>> languages = await _loadLanguagesAsync();
  return languages;
}
