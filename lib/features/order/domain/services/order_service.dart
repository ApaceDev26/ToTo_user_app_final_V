...
class OrderService implements OrderServiceInterface {
  ...
  dynamic _sortOutProductAddToCard(List<Variation>? orderedVariation,
    ...
    bool hasAllRequiredVariations = _hasAllRequiredVariations(currentFood);
    double basePrice = hasAllRequiredVariations ? 0 : price;
    double? priceWithDiscount =
        PriceConverter.convertWithDiscount(basePrice, discount, discountType);

    double priceWithVariation = basePrice + variationPrice;
