import 'package:toto_user/common/widgets/my_text_field_widget.dart';
...
import 'package:toto_user/features/review/widgets/delivery_man_widget.dart';
...
class _DeliveryManReviewWidgetState extends State<DeliveryManReviewWidget> {
  ...
  void initState() {
    super.initState();
    // Load existing review when widget is initialized
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.deliveryMan != null) {
        Get.find<ReviewController>().loadExistingDeliveryManReview(
          widget.orderID,
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ReviewController>(builder: (reviewController) {
      final existingReview = reviewController.existingDeliveryManReview;
                            ...
                            Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, i) {
                                        return Icon(
                                          (existingReview.rating ?? 0) < (i + 1)
                                              ? Icons.star_border
                                              : Icons.star,
                                          size: 25,
                                          color: (existingReview.rating ?? 0) <
                                                  (i + 1)
                                  ...
                                  if (existingReview.comment != null &&
                                      existingReview.comment!.isNotEmpty) ...[
                                    Text(
                            ...
                            Column(children: [
                                ...
                                Padding(
                                  ...
                                  child: CustomButtonWidget(
                                    ...
                                    onPressed: () {
                                      if (reviewController.deliveryManRating ==
                                          0) {
