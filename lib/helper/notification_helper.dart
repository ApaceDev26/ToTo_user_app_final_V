import 'dart:convert';
import 'dart:io';
import 'package:toto_user/common/widgets/demo_reset_dialog_widget.dart';
...
class NotificationHelper {
  static Future<void> initialize(
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      debugPrint("onMessage notification: ${message.notification?.title}");
...
Future<dynamic> myBackgroundMessageHandler(RemoteMessage message) async {
  ...
  debugPrint("onBackground notification: ${message.notification?.title}");
