...
import 'package:toto_user/features/chat/widgets/conversion_details_shimmer.dart';
...
import 'package:toto_user/features/chat/widgets/message_bubble_widget.dart';
import 'package:toto_user/helper/responsive_helper.dart';
import 'package:toto_user/helper/route_helper.dart';
import 'package:toto_user/common/enums/user_type.dart';
          ...
          appBar: !isDesktop
              ? AppBar(
                  ...
                  leading: IconButton(
                    ...
                    icon: Icon(Icons.arrow_back_ios, color: colors.ink),
                  ),
                  title: Row(children: [
                    ClipOval(
                      child: (widget.notificationBody?.adminId != null ||
                          ...
                          : CustomImageWidget(
                              image:
                                  '${chatController.messageModel != null && chatController.messageModel!.conversation != null && chatController.messageModel!.conversation!.receiver != null ? chatController.messageModel!.conversation!.receiver!.imageFullUrl ?? '' : ''}',
                              fit: BoxFit.cover,
                              height: 35,
                              width: 35,
                            ),
                                                              ...
                                                              child: TextField(
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  hintText:
                                                                      'type_a_massage'
                                                                          .tr,
                                                                  hintStyle: AppTypography.bodyLg(colors.inkFaint),
                                                                ),
                                                                onSubmitted:
                                                                    (String
                                                                        newText) {
