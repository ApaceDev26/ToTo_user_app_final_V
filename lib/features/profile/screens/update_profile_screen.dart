...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
  ...
  bool _isDummyOtpEmail(String? email) {
    if (email == null || email.isEmpty) {
      return false;
    }
    return RegExp(r'^otp_user_[0-9_]+@tastyso\.local$')
          ...
          GetBuilder<ProfileController>(builder: (profileController) {
            if (profileController.userInfoModel != null &&
              ...
              _emailController.text =
                  _isDummyOtpEmail(serverEmail) ? '' : (serverEmail ?? '');
            }
                                                        ...
                                                        CustomTextFieldWidget(
                                                          ...
                                                          suffixImage: profileController
                                                              ...
                                                              : Get.find<SplashController>()
                                                                      ...
                                                                      !_isDummyOtpEmail(profileController
                                                                          .userInfoModel!
                                                                          .email)
                                                                  ? Images
                                                                      .unVerifiedIcon
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                  right: 10,
                                  top: 10,
                                  child: !profileController.userInfoModel!
                                              .isPhoneVerified! &&
                                          Get.find<SplashController>()
                                              .configModel!
                                              .centralizeLoginSetup!
