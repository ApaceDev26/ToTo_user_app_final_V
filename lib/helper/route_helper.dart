import 'dart:convert';
import 'package:toto_user/common/widgets/image_viewer_screen_widget.dart';
...
import 'package:toto_user/features/auth/screens/new_user_setup_screen.dart';
import 'package:toto_user/features/business/screens/subscription_payment_screen.dart';
import 'package:toto_user/features/business/screens/subscription_success_or_failed_screen.dart';
...
import 'package:toto_user/features/checkout/domain/models/pricing_view_model.dart';
import 'package:toto_user/features/checkout/screens/checkout_screen.dart';
import 'package:toto_user/features/checkout/screens/offline_payment_screen.dart';
import 'package:toto_user/features/checkout/screens/order_successful_screen.dart';
import 'package:toto_user/features/checkout/screens/payment_screen.dart';
import 'package:toto_user/features/checkout/screens/payment_webview_screen.dart';
import 'package:toto_user/features/dine_in/screens/dine_in_restaurant_screen.dart';
import 'package:toto_user/features/favourite/screens/favourite_screen.dart';
import 'package:toto_user/features/home/screens/map_view_screen.dart';
import 'package:toto_user/features/html/enums/html_type.dart';
import 'package:toto_user/features/html/screens/html_viewer_screen.dart';
import 'package:toto_user/features/language/screens/language_screen.dart';
import 'package:toto_user/features/menu/screens/skylon_it_screen.dart';
import 'package:toto_user/features/location/screens/access_location_screen.dart';
import 'package:toto_user/features/location/screens/map_screen.dart';
import 'package:toto_user/features/location/screens/pick_map_screen.dart';
import 'package:toto_user/features/notification/domain/models/notification_body_model.dart';
import 'package:toto_user/features/notification/screens/notification_screen.dart';
import 'package:toto_user/features/onboard/screens/onboarding_screen.dart';
import 'package:toto_user/features/order/screens/guest_track_order_screen.dart';
...
import 'package:toto_user/features/order/screens/order_tracking_screen.dart';
import 'package:toto_user/features/order/screens/refund_request_screen.dart';
import 'package:toto_user/features/profile/domain/models/update_user_model.dart';
import 'package:toto_user/features/profile/screens/profile_screen.dart';
import 'package:toto_user/features/profile/screens/update_profile_screen.dart';
import 'package:toto_user/features/refer%20and%20earn/screens/refer_and_earn_screen.dart';
import 'package:toto_user/features/restaurant/screens/all_restaurant_screen.dart';
import 'package:toto_user/features/restaurant/screens/campaign_screen.dart';
import 'package:toto_user/features/restaurant/screens/restaurant_product_search_screen.dart';
...
import 'package:toto_user/features/review/screens/rate_review_screen.dart';
import 'package:toto_user/features/review/screens/review_screen.dart';
import 'package:toto_user/features/search/screens/search_screen.dart';
...
import 'package:toto_user/features/address/screens/add_address_screen.dart';
import 'package:toto_user/features/address/screens/address_screen.dart';
import 'package:toto_user/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:toto_user/features/auth/screens/restaurant_registration_screen.dart';
import 'package:toto_user/features/auth/screens/sign_in_screen.dart';
import 'package:toto_user/features/auth/screens/sign_up_screen.dart';
import 'package:toto_user/features/category/screens/category_product_screen.dart';
import 'package:toto_user/features/category/screens/category_screen.dart';
import 'package:toto_user/features/chat/domain/models/conversation_model.dart';
import 'package:toto_user/features/chat/screens/chat_screen.dart';
import 'package:toto_user/features/chat/screens/conversation_screen.dart';
import 'package:toto_user/features/coupon/screens/coupon_screen.dart';
import 'package:toto_user/features/cuisine/screens/cuisine_restaurant_screen.dart';
import 'package:toto_user/features/cuisine/screens/cuisine_screen.dart';
import 'package:toto_user/features/dashboard/screens/dashboard_screen.dart';
import 'package:toto_user/features/interest/screens/interest_screen.dart';
import 'package:toto_user/features/loyalty/screens/loyalty_screen.dart';
import 'package:toto_user/features/product/screens/item_campaign_screen.dart';
import 'package:toto_user/features/product/screens/popular_food_screen.dart';
import 'package:toto_user/features/splash/domain/models/deep_link_body.dart';
import 'package:toto_user/features/splash/screens/splash_screen.dart';
import 'package:toto_user/features/support/screens/support_screen.dart';
import 'package:toto_user/features/update/screens/update_screen.dart';
...
import 'package:toto_user/features/verification/screens/new_pass_screen.dart';
import 'package:toto_user/features/verification/screens/verification_screen.dart';
import 'package:toto_user/features/wallet/screens/wallet_screen.dart';
import 'package:toto_user/features/wallet/screens/withdraw_history_screen.dart';
import 'package:toto_user/helper/address_helper.dart';
import 'package:toto_user/helper/maintance_helper.dart';
...
class RouteHelper {
  ...
  static const String skylonIt = '/skylon-it';
  ...
  static String getForgotPassRoutePhone() => forgotPasswordPhone;
  ...
  static String getOrderSuccessRoute(
          ...
          {bool? isDeliveryOrder, String? message}) {
    final encodedMessage = (message != null && message.isNotEmpty)
        ? Uri.encodeQueryComponent(message)
        : '';
    return '$orderSuccess?id=$orderID&status=$status&amount=$amount&contact_number=$contactNumber&is_delivery_order=$isDeliveryOrder${encodedMessage.isNotEmpty ? '&message=$encodedMessage' : ''}';
  }
  ...
  static String getAddAddressRoute(bool fromCheckout, int? zoneId,
          {bool forGuest = false, bool fromNewUser = false}) =>
      '$addAddress?page=${fromCheckout ? 'checkout' : 'address'}&zone_id=$zoneId&for_guest=$forGuest&from_new_user=$fromNewUser';
  ...
  static String getSkylonItRoute() => skylonIt;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: forgotPasswordPhone, page: () => ForgetPassScreenPhone()),
    ...
    GetPage(
      ...
      customTransition: _SlideRightToLeftTransition(),
    ...
    GetPage(
        ...
        page: () {
          return getRoute(OrderSuccessfulScreen(
            ...
            failureMessage: Get.parameters['message'],
          ));
        }),
    GetPage(
        name: payment,
    ...
    GetPage(
        ...
        page: () => getRoute(AddAddressScreen(
              ...
              zoneId: Get.parameters['zone_id'] != null &&
                      Get.parameters['zone_id'] != 'null'
                  ? int.parse(Get.parameters['zone_id']!)
                  : null,
              forGuest: Get.parameters['for_guest'] == 'true',
              fromNewUser: Get.parameters['from_new_user'] == 'true',
            ))),
    GetPage(
        name: editAddress,
        page: () {
    ...
    GetPage(
        ...
        page: () => getRoute(const WithdrawHistoryScreen())),
    ...
    GetPage(
        name: skylonIt,
        page: () => getRoute(byPuss: true, const SkylonItScreen())),
    GetPage(
...
class _SlideRightToLeftTransition extends CustomTransition {
  @override
