    ...
    return Padding(
      ...
      child: Container(
          ...
          gradient: LinearGradient(
            colors: [
              Theme.of(context).primaryColor.withValues(
                  alpha: Get.find<ThemeController>().darkTheme ? 0.5 : 0.07),
              Theme.of(context).primaryColor.withValues(
                  alpha: Get.find<ThemeController>().darkTheme ? 0.5 : 0.1),
              Theme.of(context).primaryColor.withValues(
                  alpha: Get.find<ThemeController>().darkTheme ? 0.5 : 0.2),
              Theme.of(context).primaryColor.withValues(
                  alpha: Get.find<ThemeController>().darkTheme ? 0.5 : 0.25),
            ],
        ...
        child: Row(children: [
          ...
          Expanded(
            child: Row(children: [
              CustomAssetImageWidget(Images.nearbyRestaurant,
