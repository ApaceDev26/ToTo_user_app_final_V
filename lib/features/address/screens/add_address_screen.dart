...
class _AddAddressScreenState extends State<AddAddressScreen> {
        ...
        title: widget.forGuest
            ...
            : widget.fromNewUser
                ...
                : widget.address == null
                    ? 'add_new_address'.tr
                    : 'update_address'.tr,
        onBackPressed: widget.fromNewUser
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  padding: EdgeInsets.all(
                      isDesktop ? 0 : Dimensions.paddingSizeDefault),
                  child: Column(children: [
                    WebScreenTitleWidget(
                        title: widget.fromNewUser
                            ? 'Add Delivery Address'.tr
                            : widget.address == null
                                ? 'add_new_address'.tr
                                : 'update_address'.tr),
  ...
  void _onSaveButtonPressed(LocationController locationController) async {
    String contactNumber = _contactPersonNumberController.text.trim();
    // Remove leading 0 for Bangladesh (+880) country code
    if (_countryDialCode == "+880" &&
        contactNumber.isNotEmpty &&
        contactNumber.startsWith("0")) {
      contactNumber = contactNumber.substring(1);
    }
    String numberWithCountryCode = _countryDialCode! + contactNumber;
