import 'package:toto_user/common/widgets/product_shimmer_widget.dart';
...
class _PaginatedListViewWidgetState extends State<PaginatedListViewWidget> {
  ...
  static const int _productPageLimit = 12;

  void _paginate() async {
    int pageSize = (widget.totalSize! / _productPageLimit).ceil();
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(children: [
        ...
        (ResponsiveHelper.isDesktop(context) && (widget.totalSize == null || _offset! >= (widget.totalSize! / _productPageLimit).ceil() || _offsetList.contains(_offset!+1))) ? const SizedBox() : _isLoading ? GridView.builder(
          shrinkWrap: true,
          physics: const NeverScrollableScrollPhysics(),
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisSpacing: Dimensions.paddingSizeLarge,
            mainAxisSpacing: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeLarge : 0.01,
            mainAxisExtent: ResponsiveHelper.isDesktop(context) ? 142 : 150,
            crossAxisCount: ResponsiveHelper.isMobile(context) ? 1 : 3,
          ),
          itemCount: ResponsiveHelper.isMobile(context) ? 3 : 6,
          ...
          child: (ResponsiveHelper.isDesktop(context) && widget.totalSize != null) ? InkWell(
            onTap: _paginate,
            child: Container(
