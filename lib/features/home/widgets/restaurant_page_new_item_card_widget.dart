...
class RestaurantPageNewItemCardWidget extends StatelessWidget {
  final Product product;
  final bool? isBestItem;
  final bool? isPopularNearbyItem;
  final bool isCampaignItem;
  final double width;
  const RestaurantPageNewItemCardWidget(
      {super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
        Expanded(
          flex: ResponsiveHelper.isDesktop(context) ? 2 : 2,
          child: InkWell(
            onTap: () {
        ...
        Expanded(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Restaurant name not shown on restaurant page
                Row(
                  ...
                  children: [
                    ...
                    GetBuilder<ProductController>(builder: (productController) {
                      return GetBuilder<CartController>(
                        ...
                        // Get the actual cart item from the cart list to ensure we have the correct ID
                        CartModel? actualCartModel;
                        if (cartIndex >= 0 &&
                            cartIndex < cartController.cartList.length) {
                          actualCartModel = cartController.cartList[cartIndex];
                        }

                        return cartQty != 0 && actualCartModel != null
                            ? Container(
                                decoration: BoxDecoration(
                                  color: Theme.of(context).cardColor,
                                    ...
                                    child: Container(
                                      ...
                                      padding: const EdgeInsets.all(
                                          Dimensions.paddingSizeExtraSmall *
                                              0.5),
                                      child: cartController.cartList[cartIndex]
                                                  .quantity! >
                                              1
                                          ? Icon(
                                              Icons.remove,
...
class NewItemCardShimmer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: ResponsiveHelper.isDesktop(context) ? 220 : 200,
