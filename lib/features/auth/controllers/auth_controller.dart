      ...
      verificationFailed: (FirebaseAuthException e) {
        ...
        switch (e.code) {
          ...
          case 'too-many-requests':
            errorMessage = 'too_many_requests_try_again_later'.tr;
            break;
          case 'operation-not-allowed':
            errorMessage = 'phone_authentication_not_enabled'.tr;
            break;
          case 'quota-exceeded':
            errorMessage = 'quota_exceeded_try_again_later'.tr;
            break;
          case 'app-not-authorized':
            errorMessage = 'app_not_authorized_for_phone_auth'.tr;
            break;
          case 'captcha-check-failed':
            errorMessage = 'captcha_verification_failed_try_again'.tr;
            break;
          ...
          case 'missing-phone-number':
            errorMessage = 'phone_number_required'.tr;
            break;
          case 'credential-already-in-use':
            errorMessage = 'phone_number_already_in_use'.tr;
            break;
          default:
            // Handle device blocking and other unknown errors
            if (e.message?.contains('blocked') == true ||
                e.message?.contains('unusual activity') == true) {
              errorMessage = 'device_temporarily_blocked_try_again_later'.tr;
            } else {
