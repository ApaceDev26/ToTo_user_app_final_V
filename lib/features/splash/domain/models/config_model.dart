class ConfigModel {
  ...
  bool? addFundStatus;
  bool? customerWithdrawStatus;
  double? customerMinWithdrawAmount;
  double? customerMaxWithdrawAmount;
  ...
  ConfigModel({
    ...
    this.addFundStatus,
    this.customerWithdrawStatus,
    this.customerMinWithdrawAmount,
    this.customerMaxWithdrawAmount,
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    customerWithdrawStatus = json['customer_withdraw_status'] == 1;
    customerMinWithdrawAmount = json['customer_min_withdraw_amount'] != null ? json['customer_min_withdraw_amount'].toDouble() : 0.0;
    customerMaxWithdrawAmount = json['customer_max_withdraw_amount'] != null ? json['customer_max_withdraw_amount'].toDouble() : 0.0;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['customer_withdraw_status'] = customerWithdrawStatus;
    data['customer_min_withdraw_amount'] = customerMinWithdrawAmount;
    data['customer_max_withdraw_amount'] = customerMaxWithdrawAmount;
...
class AdminFreeDelivery {
  ...
  bool? freeDeliveryForNewCustomer;

  AdminFreeDelivery({this.status, this.type, this.freeDeliveryOver, this.freeDeliveryDistance, this.freeDeliveryForNewCustomer});
  ...
  AdminFreeDelivery.fromJson(Map<String, dynamic> json) {
    ...
    freeDeliveryForNewCustomer = json['free_delivery_for_new_customer'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['free_delivery_for_new_customer'] = freeDeliveryForNewCustomer;
    return data;
  }
}