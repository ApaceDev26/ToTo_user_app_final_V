...
class _ProductReviewWidgetState extends State<ProductReviewWidget> {
  ...
  void initState() {
    super.initState();
    // Load existing reviews when widget is initialized
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<ReviewController>()
          .loadExistingProductReviews(widget.orderDetailsList);
    });
  }
            ...
            child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final productId =
                        widget.orderDetailsList[index].foodDetails?.id;
                    final existingReview = productId != null
                        ? reviewController.existingProductReviews[productId]
                        : null;
