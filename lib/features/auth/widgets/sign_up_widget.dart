...
class SignUpWidgetState extends State<SignUpWidget> {
      ...
      child: Container(
        ...
        child: GetBuilder<AuthController>(builder: (authController) {
          return Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Padding(
              padding:
                  EdgeInsets.all(isDesktop ? Dimensions.paddingSizeLarge : 0),
              child: Column(
                  ...
                  children: [
                    ...
                    Row(children: [
                      Expanded(
                        child: CustomTextFieldWidget(
                          ...
                          validator: (value) => ValidateCheck.validateName(
                    ...
                    TramsConditionsCheckBoxWidget(
                        ...
                        fromSignUp: true,
                        fromDialog: isDesktop ? true : false),
                    SizedBox(
                        height: isDesktop
                            ? Dimensions.paddingSizeLarge
  ...
  void _handleResponse(ResponseModel status, String countryCode) {
    ...
    if (status.isSuccess) {
      ...
      if (status.authResponseModel != null &&
        ...
        // Check if user needs personal info setup
        if (status.authResponseModel != null &&
            !status.authResponseModel!.isPersonalInfo!) {
          // User needs to complete personal info setup first
          if (ResponsiveHelper.isDesktop(context)) {
            Get.back();
          ...
          // User is fully verified, go to location screen
  ...
  Future<SignUpBodyModel?> _prepareSignUpBody(String countryCode) async {
    ...
    if (countryCode == "+880" && number.isNotEmpty && number.startsWith("0")) {
    ...
    if (_formKeySignUp!.currentState!.validate()) {
      ...
      } else if (!email.trim().toLowerCase().endsWith('.com')) {
