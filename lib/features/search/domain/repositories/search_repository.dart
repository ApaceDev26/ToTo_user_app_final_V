...
import 'package:toto_user/features/search/domain/models/search_suggestion_model.dart';
...
class SearchRepository implements SearchRepositoryInterface {
  ...
  Future<Response> getSearchData(
      ...
      int? isOpenRestaurant}) async {
    return await apiClient.getData(
        '${AppConstants.searchUri}${isRestaurant ? 'restaurants' : 'products'}/search?name=$query&offset=$offset&limit=10'
