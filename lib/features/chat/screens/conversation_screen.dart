...
import 'package:toto_user/features/chat/widgets/chat_serach_field_widget.dart';
import 'package:toto_user/features/chat/widgets/message_card_widget.dart';
...
import 'package:toto_user/features/chat/widgets/web_chat_view_widget.dart';
...
class _ConversationScreenState extends State<ConversationScreen>
  ...
  void _decideResult(ConversationsModel? conversation) {
    ...
    // Only delivery_man tab is available, so always set to delivery_man
    ...
    // Note: vendor type is no longer supported as the restaurants tab is hidden
  }
                                      ...
                                      SliverPersistentHeader(
                                        ...
                                        delegate: SliverDelegate(
                                          ...
                                          child: TabBar(
                                            ...
                                            onTap: (int index) {
                                              // Only delivery_man tab is available
                                              chatController
                      ...
                      : (type == chatController.type)
                          ? Container(
                              ...
                              decoration: BoxDecoration(
                                color:
                                    unSeen ? colors.accentSoft : colors.surface,
